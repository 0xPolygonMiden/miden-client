...
miden init --rpc 114.28.66.133
# You can specify the port
miden init --rpc 114.28.66.133:8080
# You can also specify the protocol (http/https)
miden init --rpc https://114.28.66.133
# You can specify both
miden init --rpc https://114.28.66.133:1234
...
miden init --rpc 114.28.66.133 --store_path db/store.sqlite3
```
