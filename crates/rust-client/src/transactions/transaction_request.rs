...
pub struct TransactionRequest {
    ...
    /// Notes to be generated by the transaction's script.
...
impl TransactionRequest {
    ...
    pub fn with_native_output_notes(mut self, notes: Vec<PartialNote>) -> Self {
        self.native_output_notes = notes;
        self
    }
    ...
    pub fn native_output_notes(&self) -> &[PartialNote] {
        &self.native_output_notes
    }
