...
pub enum ScriptSource {
    ...
    NativeOutputNotes(Vec<PartialNote>),
}
...
pub struct TransactionRequest {
    ...
    /// Source for the transaction script.
...
impl TransactionRequest {
    ...
    pub fn new(account_id: AccountId) -> Self {
        Self {
            ...
            script_source: ScriptSource::NativeOutputNotes(vec![]),
    ...
    pub fn with_native_output_notes(mut self, notes: Vec<PartialNote>) -> Self {
        self.script_source = ScriptSource::NativeOutputNotes(notes);
        self
    }

    pub fn with_custom_script(mut self, script: TransactionScript) -> Self {
        self.script_source = ScriptSource::CustomScript(script);
        self
    }
    ...
    pub fn script_source(&self) -> &ScriptSource {
        &self.script_source
    }
