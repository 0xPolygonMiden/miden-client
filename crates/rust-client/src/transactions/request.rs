...
pub struct TransactionRequest {
    ...
    script_template: TransactionScriptTemplate,
...
impl TransactionRequest {
    ...
    pub fn new(account_id: AccountId) -> Self {
        Self {
            ...
            script_template: TransactionScriptTemplate::OutputNotes(vec![]),
    ...
    pub fn with_native_output_notes(
        ...
        if let TransactionScriptTemplate::CustomScript(_) = self.script_template {
            return Err(TransactionRequestError::ScriptTemplateError(
                "Cannot set native notes when custom script is already set".to_string(),
            ));
        }
    ...
    pub fn with_custom_script(
        ...
        if let TransactionScriptTemplate::OutputNotes(_) = self.script_template {
            return Err(TransactionRequestError::ScriptTemplateError(
                "Cannot set custom script when native notes are already set".to_string(),
            ));
        }
