...
pub struct TonicRpcClient {
    client: RwLock<Option<ApiClient<InnerClient>>>,
    endpoint: String,
    #[allow(dead_code)]
    timeout_ms: u64,
}

#[allow(clippy::await_holding_lock, clippy::unused_async)]
impl TonicRpcClient {
    ...
    async fn ensure_connected(
        &self,
    ) -> Result<RwLockWriteGuard<Option<ApiClient<InnerClient>>>, RpcError> {
