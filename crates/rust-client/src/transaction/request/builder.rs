...
pub struct TransactionRequestBuilder {
    ...
    /// Notes to be created by the transaction. This includes both full notes and partial notes.
    /// This field is used to specify the output notes that should be created in the transaction
    /// script and will be used as a transaction script template.
