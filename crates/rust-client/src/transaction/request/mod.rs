...
pub struct TransactionRequest {
    ...
    expected_output_notes: BTreeMap<NoteId, OutputNote>,
...
impl TransactionRequest {
    ...
    pub fn expected_output_notes(&self) -> impl Iterator<Item = &OutputNote> {
...
impl Deserializable for TransactionRequest {
    fn read_from<R: ByteReader>(source: &mut R) -> Result<Self, DeserializationError> {
        ...
        let expected_output_notes = BTreeMap::<NoteId, OutputNote>::read_from(source)?;
