...
use miden_objects::{
    account::AccountId, assembly::AssemblyError, crypto::merkle::MerkleStore, note::{Note, NoteDetails, NoteId, NoteRecipient, NoteTag, PartialNote}, transaction::{OutputNote, TransactionArgs, TransactionScript}, vm::AdviceMap, Digest, Felt, NoteError, Word
};
...
use super::extend_advice_inputs_for_foreign_account;
