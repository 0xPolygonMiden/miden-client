...
pub struct TransactionRequest {
    ...
    expected_partial_output_notes: Vec<NoteDetails>,
...
impl TransactionRequest {
    ...
    pub fn expected_partial_output_notes(&self) -> &[NoteDetails] {
        &self.expected_partial_output_notes
    }
