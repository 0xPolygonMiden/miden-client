...
pub struct TransactionRequest {
    ...
    /// A list of note details of notes we expect to be created in the future.
    expected_payback_note_details: Vec<NoteDetails>,
...
impl TransactionRequest {
    ...
    pub fn expected_payback_note_details(&self) -> &[NoteDetails] {
        &self.expected_payback_note_details
    }
