...
// LIST INPUT NOTES
// ================================================================================================
fn list_input_notes<N: NodeRpcClient, R: FeltRng, S: Store, A: TransactionAuthenticator>(
...
// SHOW INPUT NOTE
// ================================================================================================
fn show_input_note<N: NodeRpcClient, R: FeltRng, S: Store, A: TransactionAuthenticator>(
    client: Client<N, R, S, A>,
    note_id: String,
    show_script: bool,
    show_vault: bool,
