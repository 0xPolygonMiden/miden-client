...
impl SyncCmd {
    pub async fn execute<N: NodeRpcClient, R: FeltRng, S: Store, A: TransactionAuthenticator>(
        ...
        println!("New public notes: {}", new_details.new_notes.len());
        println!("Tracked notes updated: {}", new_details.new_inclusion_proofs.len());
        println!("Tracked notes consumed: {}", new_details.new_nullifiers.len());
        println!("Tracked accounts updated: {}", new_details.updated_onchain_accounts.len());
